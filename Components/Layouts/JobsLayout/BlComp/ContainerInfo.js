...
<Table className='tableFixHead' bordered>
    ...
    <tbody>
      {console.log(state.Container_Infos)}
    ...
    <td className='p-0'><DatePicker value={x.date ? moment(x.date) : null}  style={{width: 130  }} size='small' onChange={(e)=>onChange(e,i,'date','e'    )}    /></td>
